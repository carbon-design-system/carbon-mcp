...
<UnorderedList>
  ...
  <ListItem>Once your access request has been approved, you will receive an email to activate your credentials</ListItem>
</UnorderedList>
...
<UnorderedList>
  ...
  <ListItem>Paste the [Carbon MCP system prompt](#carbon-mcp-client-system-prompt) into the `Workspace Rules` editor</ListItem>
  <ListItem>Save the rule to apply it as a system prompt for the workspace</ListItem>
</UnorderedList>
